...
var AdventureGame = /** @class */ (function () {
    ...
    AdventureGame.prototype.askQuestion = function (question) {
        var _this = this;
        return new Promise(function (resolve) { return _this.rl.question(question, resolve); });
    };
    AdventureGame.prototype.play = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.askQuestion("Which direction do you want to go? (n/s/e/w): ")];
                    case 2:
                        direction = _a.sent();
